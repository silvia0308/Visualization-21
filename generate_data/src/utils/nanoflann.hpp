// This file is modified from nanoflann library
// [Link] https://github.com/jlblancoc/nanoflann
...
public:
  ...
  inline void setMax(const double &max_dist) {dists[capacity - 1] = max_dist;}
